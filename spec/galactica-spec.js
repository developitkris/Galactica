...
describe('Galactica', function() {
  ...
  it('should test that age can be converted to seconds', function(){
    expect(newGalacticCalc.ageIntoSec(21)).toEqual(6.623e+11);
  });
  ...
  it('should test that difference in two dates can be expressed in milliseconds', function(){
    expect(newGalacticCalc.earthDateDiff(2018/05/25, 2018/05/27)).toEqual(00/00/02);
  });
